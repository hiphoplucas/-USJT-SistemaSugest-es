                    ...
                    <div class="col-md-12" id=sugestaoAvalia>
                                 <c:if test="${not empty listaSugestaoAvalia}">
                                    <c:forEach var="sugestao" items="${listaSugestaoAvalia}">                    
                                        ...
                                        <div class="pData">
                                            ${sugestao.data } | ${sugestao.nomeEspecialidade } | <spam class="pVerMais"><a href="controller.do?command=CarregaSugestaoPAvalia&id=${sugestao.idSugestao }"><button type="button"">Avaliar a Sugestão</button></a></spam> <br><br>
                                        </div>
                                        </div>
                                    </c:forEach>
                                </c:if>
